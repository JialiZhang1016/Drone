#!/bin/bash
#SBATCH --job-name=scenario_5_8_loc_unstable
#SBATCH --output=runs/output/scenario_5-%j.out
#SBATCH --error=runs/output/scenario_5-%j.err
...
echo "Starting scenario 5: 8_loc_unstable..."
echo "Parameters: Locations=8, WeatherProb=0.5, ExtremeProb=0.15"

# Run the single scenario
python run_single_scenario.py 5

echo "Scenario 5 completed at: $(date)"
