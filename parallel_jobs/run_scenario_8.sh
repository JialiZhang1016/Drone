#!/bin/bash
#SBATCH --job-name=scenario_8_15_loc_extreme
#SBATCH --output=runs/output/scenario_8-%j.out
#SBATCH --error=runs/output/scenario_8-%j.err
...
echo "Starting scenario 8: 15_loc_extreme..."
echo "Parameters: Locations=15, WeatherProb=0.4, ExtremeProb=0.2"

# Run the single scenario
python run_single_scenario.py 8

echo "Scenario 8 completed at: $(date)"
