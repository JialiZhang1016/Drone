#!/bin/bash
#SBATCH --job-name=scenario_3_20_loc_stable
#SBATCH --output=runs/output/scenario_3-%j.out
#SBATCH --error=runs/output/scenario_3-%j.err
...
echo "Starting scenario 3: 20_loc_stable..."
echo "Parameters: Locations=20, WeatherProb=0.8, ExtremeProb=0.05"

# Run the single scenario
python run_single_scenario.py 3
