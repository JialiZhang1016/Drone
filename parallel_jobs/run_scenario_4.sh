#!/bin/bash
#SBATCH --job-name=scenario_4_5_loc_unstable
#SBATCH --output=runs/output/scenario_4-%j.out
#SBATCH --error=runs/output/scenario_4-%j.err
...
echo "Starting scenario 4: 5_loc_unstable..."
echo "Parameters: Locations=5, WeatherProb=0.5, ExtremeProb=0.15"

# Run the single scenario
python run_single_scenario.py 4

echo "Scenario 4 completed at: $(date)"
