#!/bin/bash
#SBATCH --job-name=scenario_2_15_loc_stable
#SBATCH --output=runs/output/scenario_2-%j.out
#SBATCH --error=runs/output/scenario_2-%j.err
...
echo "Starting scenario 2: 15_loc_stable..."
echo "Parameters: Locations=15, WeatherProb=0.8, ExtremeProb=0.05"

# Run the single scenario
python run_single_scenario.py 2
