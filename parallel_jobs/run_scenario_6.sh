#!/bin/bash
#SBATCH --job-name=scenario_6_15_loc_unstable
#SBATCH --output=runs/output/scenario_6-%j.out
#SBATCH --error=runs/output/scenario_6-%j.err
...
echo "Starting scenario 6: 15_loc_unstable..."
echo "Parameters: Locations=15, WeatherProb=0.5, ExtremeProb=0.15"

# Run the single scenario
python run_single_scenario.py 6

echo "Scenario 6 completed at: $(date)"
