...
def evaluate_dqn(
    ...
    Parameters:
        ...
        verbose (bool, optional): If True, prints actions, states, and episode results. Defaults to True.
    ...
    for episode in range(1, num_episodes + 1):
        ...
        while not done:
            ...
            if verbose:
                print(f"Episode {episode}, Step {steps + 1}: State: {state}")
...
if __name__ == "__main__":
    evaluation_results = evaluate_dqn(
        ...
        model_path="runs/2024-12-05_18:15:46_wp_0.6_8_10000/policy_net_final.pth",
        num_episodes=10,
